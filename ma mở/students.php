        ...
        <div class="card-header">
            <div>
                ...
                <div style="font-size:0.8rem;color:var(--gray);margin-top:4px;">
                    ⏱ <?= $quiz['time_limit'] ?> phút &nbsp;|&nbsp; ✅ Điểm qua môn: <?= $quiz['passing_score'] ?>%
                </div>
            </div>
...
<div class="container" style="max-width:600px;padding-top:60px;padding-bottom:60px;text-align:center;">
    <div class="card">
        ...
        <p style="color:var(--gray);margin-bottom:32px;"><?= $passed ? 'Bạn đã hoàn thành bài kiểm tra xuất sắc!' : 'Hãy ôn luyện thêm và thử lại!' ?></p>
        <div style="background:<?= $passed?'#d1fae5':'#fee2e2' ?>;border-radius:var(--radius);padding:32px;margin-bottom:24px;">
            <div style="font-size:3.5rem;font-weight:800;color:<?= $passed?'var(--success)':'var(--danger)' ?>;"><?= $score ?>%</div>
            <div style="font-size:0.875rem;color:var(--gray);">Điểm của bạn | Điểm qua môn: <?= $quiz['passing_score'] ?>%</div>
        </div>
...
<div class="container" style="padding-top:32px;padding-bottom:48px;">
    ...
    <div class="card">
        ...
        <div class="progress" style="margin-bottom:16px;"><div class="progress-bar" style="width:<?= $progress ?>%"></div></div>
